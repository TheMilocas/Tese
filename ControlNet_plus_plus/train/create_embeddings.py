...
if __name__ == "__main__":
    base_dir = os.path.abspath("comparison_outputs_random_seed_FFHQ_set/base")
    controlnet_dir = os.path.abspath("comparison_outputs_random_seed_FFHQ_set/controlnet")

    save_embeddings_for_folder(base_dir, "comparison_outputs_random_seed_FFHQ_set/embeddings_base")
    save_embeddings_for_folder(controlnet_dir, "comparison_outputs_random_seed_FFHQ_set/embeddings_controlnet")
