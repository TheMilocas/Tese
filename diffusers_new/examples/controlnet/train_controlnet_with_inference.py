...
def run_mid_training_inference(checkpoint_path, output_dir):
    """
    Runs inference using the latest checkpoint and saves the output image.

    Args:
        checkpoint_path (str): Path to the latest checkpoint directory.
    ...
    print(f"Running mid-training inference with {checkpoint_name}")
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        ...
                        run_mid_training_inference(save_path, inference_output_dir)
